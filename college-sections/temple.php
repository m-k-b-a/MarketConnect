...
<nav class="navbar navbar-expand-lg navbar-light shadow" style="padding: 10px;">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <a class="navbar-brand text-success logo h1 align-self-center" href="../index.php" style="width: 240px; height: 90px; background: url('../img/temple_logo.png') no-repeat center center; background-size: contain;"></a>
...
<h1 style= "text-align: center;"> Temple Businesses</h1>
