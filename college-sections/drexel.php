...
<!--hellooooo-->
<head>
    <title >MarketConnect</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="../img/drexel_logo.png">
...
Created by TemplateMo 559 Zay Shopppppp; Modified by Mikayla Boachie-Agyeman
...
<nav class="navbar navbar-expand-lg navbar-light shadow" style="padding: 10px;">
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <a class="navbar-brand text-success logo h1 align-self-center" href="../index.php" style="width: 240px; height: 90px; background: url('../img/drexel_logo.png') no-repeat center center; background-size: contain;"></a>
        ...
        <div class="align-self-center collapse navbar-collapse flex-fill d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
            <div class="flex-fill">
                <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto" style="margin-bottom: 0;">
                    ...
                    <li class="nav-item" style="margin-right: 10px;">
                        <a class="nav-link" href="../logincode/login.php">LOGIN</a>
                    </li>
                    <li class="nav-item">
...
<h1 style = "text-align: center;"> Drexel Businesses</h1>
